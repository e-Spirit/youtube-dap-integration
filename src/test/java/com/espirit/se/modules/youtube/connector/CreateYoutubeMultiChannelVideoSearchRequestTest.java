...
class CreateYoutubeMultiChannelVideoSearchRequestTest {
	...
	void createInstance_NO_QUERY() throws IOException {
		...
		YoutubeMultiChannelVideoSearchRequest youtubeMultiChannelVideoSearchRequest = YoutubeMultiChannelVideoSearchRequest.createInstance(apikey, _youTubeMock, "", Collections.singletonList(channelMock));
